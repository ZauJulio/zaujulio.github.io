...
import { CodeIcon, ExternalLinkIcon, HeartHandshakeIcon, StarIcon } from 'lucide-react';
...
function SoftSkillCard({ name, description, index }: { name: string; description: string; index: number }) {
  ...
  return (
    <div
      className='group relative bg-gray-900/40 rounded-lg border border-gray-800/60 p-4 transition-all duration-300 hover:border-brand-500/40 hover:bg-gray-800/30'
