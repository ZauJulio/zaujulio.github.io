    ...
    <div className='min-h-screen w-full bg-black text-white font-sans selection:bg-brand-500 selection:text-white'>
      ...
      >
        ...
        <div className='relative z-10 flex flex-col items-center text-center px-4'>
          ...
          <h1 className='select-none text-5xl md:text-7xl font-bold mb-4 tracking-tight text-white drop-shadow-lg'>
            {t('hero.title')}
          </h1>

          <p className='select-none text-xl md:text-2xl text-brand-300 font-light tracking-wide'>
            {t('hero.subtitle')}
          </p>
        </div>
